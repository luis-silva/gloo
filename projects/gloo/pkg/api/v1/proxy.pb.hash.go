...
func (m *Listener) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetClientIpMatchingConfig()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("ClientIpMatchingConfig")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetClientIpMatchingConfig(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("ClientIpMatchingConfig")); err != nil {
				return 0, err
...
// Hash function
func (m *ClientIPMatchingConfig) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.ClientIPMatchingConfig")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetDefaultFilterChain()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("DefaultFilterChain")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetDefaultFilterChain(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("DefaultFilterChain")); err != nil {
				return 0, err
...
// Hash function
func (m *ClientIPMatchingConfig_DefaultFilterChain) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1.ClientIPMatchingConfig_DefaultFilterChain")); err != nil {
		return 0, err
	}
