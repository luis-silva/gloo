...
func (m *UpstreamSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("aws_tg.options.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/aws/tg.UpstreamSpec")); err != nil {
		return 0, err
	}
...
func (m *TagFilter) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("aws_tg.options.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/aws/tg.TagFilter")); err != nil {
		return 0, err
	}
...
func (m *TagFilter_KvPair) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("aws_tg.options.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/aws/tg.TagFilter_KvPair")); err != nil {
		return 0, err
	}
