...
run-security-scan:
	...
	go run  github.com/solo-io/go-utils/securityscanutils/cli  run-security-scan -f docs/cmd/osImageVersionConstraints.csv -m v1.6.0 -r gloo -w gloo -c opensource.out -u=true -i=false
